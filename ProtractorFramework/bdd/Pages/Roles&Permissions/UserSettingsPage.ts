...
export class UserSettingsPage {
  ...
  constructor() {
    ...
    this.radioButton2 = element(
      by.xpath(
        "//div[@class='form-section zebrastripe col-9']/div[3]//input[@value='self']"
      )
    );
    this.radioButton3 = element(
      by.xpath(
        "//div[@class='form-section zebrastripe col-9']/div[5]//input[@value='self']"
      )
    );
  ...
  verifyUserSettings = async () => {
    return await isElementPresent(this.userSettingsHeading).then(function(
      flag
    ) {
      return flag;
    });
