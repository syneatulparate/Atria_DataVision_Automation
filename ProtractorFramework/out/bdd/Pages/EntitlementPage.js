...
class EntitlementPage {
    constructor() {
        ...
        this.verifyRoleandPermissionColumn = () => __awaiter(this, void 0, void 0, function* () {
            ...
            // linkPresent = this.verifyElement(this.EditButton)
            // linkPresent =  this.verifyElement(this.deleteRoleButton)
            // linkPresent =  this.verifyElement(this.addUserButton)
            //linkPresent = this.verifyElement(element(by.xpath("//h1[contains(text(),'Roles & Permissions')]")))
            yield linkPresent.then(function (text) { console.log(text); });
            return linkPresent;
        });
